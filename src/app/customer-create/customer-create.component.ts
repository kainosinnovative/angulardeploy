...
readCustomerDataById() {
  ...
  return this.restApi.readCustomerDataById(currentUserId).subscribe((res)=>{
    ...
    this.CustomerProfileImg = this.CustomerDataById1.profile_img;
    this.Customerfirstname = this.CustomerDataById1.firstname;
    this. Customerlastname = this.CustomerDataById1.lastname;
    this.customeremailid = this.CustomerDataById1.emailid;
    console.log("this.CustomerDataById1>>>",this.CustomerDataById1);
